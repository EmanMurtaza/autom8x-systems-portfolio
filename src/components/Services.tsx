...
const services = [
  {
    ...
    italic: "Development",
    description:
      "Full-stack web applications built with modern frameworks. From landing pages to complex SaaS platforms, we deliver fast, scalable, and beautiful digital products.",
  ...
  },
  {
    ...
    italic: "Solutions",
    description:
      "Custom AI integrations powered by the latest LLMs. We build intelligent features that understand your users, automate decisions, and unlock new capabilities.",
  ...
  },
  {
    ...
    italic: "Automation",
    description:
      "Eliminate repetitive workflows. We design and deploy automation pipelines that connect your tools, process data, and execute tasks without human intervention.",
  ...
  },
  {
    ...
    italic: "Assistants",
    description:
      "Intelligent chatbots and voice assistants trained on your business data. Available 24/7 to handle customer support, lead qualification, and internal Q&A.",
          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                {/* Number */}
                <span className="text-xs text-muted/60 font-mono mb-auto pt-4">
                  {s.id}
                </span>
                ...
                <div className="mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-2 group-hover:translate-y-0 transform">
                  <div className="flex flex-wrap gap-2">
                    {s.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-xs px-3 py-1 rounded-full bg-surface/80 border border-stroke text-muted"
                      >
                        {tag}
                      </span>
                    ))}
