...
const projects = [
  {
    ...
    description: "Full-stack e-commerce solution with AI-powered product recommendations and automated inventory management.",
  },
  {
    ...
    description: "Real-time analytics dashboard with custom reporting engine and automated data pipeline.",
  },
  {
    ...
    description: "Intelligent chatbot trained on company knowledge base, handling 80% of support tickets autonomously.",
  },
  {
    ...
    description: "End-to-end business process automation connecting CRM, ERP, and communication tools.",
  },
];
        ...
        >
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-body font-light text-text-primary leading-tight">
              Featured{" "}
              <em className="font-display not-italic italic">projects</em>
            </h2>
            <p className="text-muted text-sm mt-3 max-w-md">
              A selection of projects built from concept to launch.
            </p>
          </div>
